        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs font-medium text-[#FFD700] uppercase tracking-widest">
                  GCU Lahore
                </p>
              </div>
            </div>
            ...
            <p className="text-slate-400 leading-relaxed text-sm max-w-sm">
              Empowering future leaders in technology through workshops,
              competitions, mentorship, and collaborative learning. Join us to
              shape the future.
            </p>
            ...
            <div className="flex gap-4 pt-2">
              {[  
...

                {
                  ...
                  label: "LinkedIn",
                  link: "https://www.linkedin.com/in/css-gcu-lahore?miniProfileUrn=urn%3Ali%3Afsd_profile%3AACoAADkMxLIBEAdDYKKrYiJGjCl5V0sNO_xK8Qw",
                },

                {
                  ...
                  label: "Instagram",
                  link: "https://www.instagram.com/css.gcu?igsh=MW9pdHNlNTlub2R6Mg==",
                  isPath: true,
                },
              ].map((social, i) => (
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-slate-800/50 flex items-center justify-center text-slate-400 hover:bg-blue-600 hover:text-white transition-all duration-300"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-4">
              {[{ name: "Home", path: "/" }, { name: "Events", path: "/events" }, { name: "Our Team", path: "/team" }, { name: "Announcements", path: "/announcements" }, { name: "Contact", path: "/contact" }, { name: "About Us", path: "/about" }].map((link, index) => (
                <li key={index}>
                  <Link
                    to={link.path}
                    className="group flex items-center text-slate-400 hover:text-[#FFD700] transition-colors duration-200"
                  >
          ...
          <div className="lg:col-span-4">
            ...
            <ul className="space-y-5">
              <li className="flex items-start gap-3 text-slate-400">
                <div className="mt-1 bg-slate-800 p-2 rounded-lg text-blue-400 shrink-0">
